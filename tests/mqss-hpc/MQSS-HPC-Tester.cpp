...
std::string backendStringTemplate =
    "mqssHPC;emulate;false;credentials;{};transpiler_flag;false;restricted_"
    "resource_names;AQT,IQM;priority;2;optimisation_level;3;preferred_qpu;"
    "planq";
...
CUDAQ_TEST(MQSSTester, checkSampleSync) {
  ...
  // std::cout << "INFO OF KERNEL: KERNEL NAME = " << kernel.name() << " second
  // name "<< name <<" QUAKE CODE = " << kernel.to_quake() << std::endl;
